 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Wishlist Data</h1>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <p class="d-inline-flex gap-1">
                <a href="{{ route('wishlist.create') }}"><span class="btn btn-primary active">Add New Wishlist</span></a>
            </p>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href=" {{ route ('wishlist.edit', $data) }}"
                                class="btn btn-primary">Edit</a>
                            <a href="/hapusWsh/{{$data->id}}"
