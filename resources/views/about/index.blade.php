...
@section('content')
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(lp/images/about.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to GreenMarket!</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>We stock the finest selections from local gardens to ensure unmatched freshness and quality. A place where natural deliciousness meets unmatched quality. As healthy food enthusiasts, we understand how important it is to include the best in each of your dishes.</p>
							<p>Our friendly and knowledgeable team is ready to help you find what you're looking for and provide the best suggestions to perfect your recipes. With friendly and attentive service, we strive to make every visit you make to our store an enjoyable and satisfying experience.</p>
                            <p>we are ready to help you live a healthy lifestyle with natural flavors. Discover the delights of nature on every visit!</p>
